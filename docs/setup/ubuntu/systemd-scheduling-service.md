...
```bash
cd /var/www/annual-sports-python-react/scheduling-service
cp .env.example .env
nano .env
```
...
User=ubuntu
Group=ubuntu
WorkingDirectory=/var/www/annual-sports-python-react/scheduling-service
EnvironmentFile=/var/www/annual-sports-python-react/scheduling-service/.env
