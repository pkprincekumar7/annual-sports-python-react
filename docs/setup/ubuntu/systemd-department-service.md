...
```bash
cd /var/www/annual-sports-python-react/department-service
cp .env.example .env
nano .env
```
...
User=ubuntu
Group=ubuntu
WorkingDirectory=/var/www/annual-sports-python-react/department-service
EnvironmentFile=/var/www/annual-sports-python-react/department-service/.env
