...
```bash
cd /var/www/annual-sports-python-react/reporting-service
cp .env.example .env
nano .env
```
...
User=ubuntu
Group=ubuntu
WorkingDirectory=/var/www/annual-sports-python-react/reporting-service
EnvironmentFile=/var/www/annual-sports-python-react/reporting-service/.env
