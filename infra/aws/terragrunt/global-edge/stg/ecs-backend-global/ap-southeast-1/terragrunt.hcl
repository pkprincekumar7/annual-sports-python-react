...
dependency "redis_global" {
  config_path = "../../redis-global"
  mock_outputs = {
    ap_southeast_1_endpoint = "redis-ap.mock.amazonaws.com"
  }
...
inputs = {
  ...
  redis_endpoint_override    = dependency.redis_global.outputs.ap_southeast_1_endpoint
