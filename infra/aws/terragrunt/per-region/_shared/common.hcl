locals {
  ...
  cloudfront_logs_bucket_by_region = {
    "us-east-1"      = "your-backend-cloudfront-logs-bucket-us-east-1"
    "eu-west-1"      = "your-backend-cloudfront-logs-bucket-eu-west-1"
    "ap-southeast-1" = "your-backend-cloudfront-logs-bucket-ap-southeast-1"
  }
